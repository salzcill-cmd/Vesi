...
def cmd_bantuan(
    ...
    *,
    ...
    print("  bantu konflik           Bantu selesaikan konflik\n")
    print("  ── Pro ──")
    print("  simpan interaktif       Wizard commit langkah demi langkah")
    print("  statistik               Statistik proyek")
    print("  auto simpan             Auto-save perubahan")
    print("  ekspor                  Export ke zip")
    print("  impor                   Import dari zip")
    print("  alias                   Custom aliases")
    print("  kunci file              File locking")
